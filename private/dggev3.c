...
void dggev3(char *JOBVL, char *JOBVR,
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    if (nrhs < 2)
        mexErrMsgIdAndTxt("dggev3:inputNotEnough", "Input argument is not enough.");
    ...
    if (nlhs == 1) {
		...
		free(ai);
		free(b);
        mexErrMsgIdAndTxt("dggev3:TooManyOutput", "Too many output.");
    }
...
void run_vec(char *jobvl, char *jobvr, double *A, double *B, double *C, double *D, double *VL, double *VR, double *ar, double *ai, double *b, mwSignedIndex *n) {
    ...
    // Get the length
    dggev3(jobvl, jobvr, n, C, n, D, n, ar, ai, b, VL, n, VR, n, dammy, &lwork, &info);
    ...
    // Run
    dggev3(jobvl, jobvr, n, C, n, D, n, ar, ai, b, VL, n, VR, n, work, &lwork, &info);
